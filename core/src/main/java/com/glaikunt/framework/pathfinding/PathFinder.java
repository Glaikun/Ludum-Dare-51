...
public interface PathFinder {
	 ...
	 * @param diagonalCost whether to add root(2)-1 (0.41421) as diagonal cost or not. Can smooth out paths.
	 * @return The path found from start to end, or null if no path can be found.
	 */
	public Path findPath(Mover mover, int sx, int sy, int tx, int ty, boolean diagonalCost);
}
